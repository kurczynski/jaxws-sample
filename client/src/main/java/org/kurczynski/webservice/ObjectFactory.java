 ...
 * generated in the org.kurczynski.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.kurczynski.org/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.kurczynski.org/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.kurczynski.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.kurczynski.org/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.kurczynski.org/", name = "helloWorldResponse")
